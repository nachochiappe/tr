...
urlpatterns = [
    ...
    url(r'^ajax/borrar_medicamento/$', borrar_medicamento, name='borrar-medicamento'),
    url(r'^ajax/derivar_paciente/$', derivar_paciente, name='derivar-paciente'),
    url(r'^ajax/obtener_especialidades/$', obtener_especialidades, name='obtener-especialidades'),
    url(r'^ajax/obtener_medicos/(?P<id>\w+)/$', obtener_medicos, name='obtener-medicos'),
    ...
    # url(r'^pacientes/(?P<id>\w+)/derivar_paciente/$', derivar_paciente, name='derivar_paciente'),
    ...
    url(r'^medicos/(?P<id>\w+)/$', MedicoDetailView.as_view(), name='medico-detalle'),
]
