...
urlpatterns = [
    ...
    url(r'^pacientes/alertas/$', PacienteDetailView.as_view(), name='paciente_alertas'),
    url(r'^pacientes/medicamentos/$', PacienteDetailView.as_view(), name='paciente_medicamentos'),
    url(r'^pacientes/estudios/$', PacienteDetailView.as_view(), name='paciente_estudios'),
    ...
    url(r'^medicos/alertas/$', MedicoDetailView.as_view(), name='medico_alertas'),
    url(r'^medicos/agenda/$', MedicoDetailView.as_view(), name='medico_agenda'),
